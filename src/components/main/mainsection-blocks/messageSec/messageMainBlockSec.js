...
import MessButtonBlock from "./../../../../../src/components/main/mainsection-blocks/messageSec/messButtonBlock.js";
import MessAdmin from "./../../../../../src/components/main/mainsection-blocks/messageSec/messAdminMes.js";
    ...
    const message = [
      {
        id: "ac-1",
        messFoto: (
          <img className="message-photo" src={victoria} alt="victoria" />
        ),
